      ...
      <View className='mt-4 px-3 flex-1 justify-between mb-2'>
        <View>
          <View className='space-y-1'>
            ...
            <Text className='text-gray-500 text-center'>Welcome to the community of Dairy Delights! Our company is dedicated to providing the finest quality milk products.</Text>
          </View>
          ...
          <TouchableOpacity activeOpacity={0.9} onPress={() => navigation.navigate('surveys')} className='mt-8 items-center border border-[#2DABB1] rounded-full w-48 mx-auto py-2'>
